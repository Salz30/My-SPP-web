...
<div class="row mb-4 align-items-center">
    <div class="col-md-6">
        <h4 class="mb-0">Buat Tagihan Baru</h4>
    </div>
        ...
        <div class="card p-4">
            <form action="{{ route('tagihan.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-lg bg-light border-0 @error('nama_tagihan') is-invalid @enderror" name="nama_tagihan" value="{{ old('nama_tagihan') }}" required placeholder="Contoh: SPP Juli 2026">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" class="form-control form-control-lg bg-light border-0 @error('tenggat_waktu') is-invalid @enderror" name="tenggat_waktu" value="{{ old('tenggat_waktu') }}" required>
                    @error('tenggat_waktu') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="text-end">
                    <button type="submit" class="btn btn-primary px-5 shadow-sm">Simpan Tagihan</button>
                </div>
            </form>
        </div>
    </div>
